<<<<<<<< Updated upstream:src/main/java/com/exercise/carrotproject/domain/post/entity/Post.java
package com.exercise.carrotproject.domain.post.entity;

import com.exercise.carrotproject.domain.common.Loc;
import com.exercise.carrotproject.domain.member.entity.Member;
========
package com.exercise.carrotproject.domain.post;

import com.exercise.carrotproject.domain.enumlist.Loc;
import com.exercise.carrotproject.domain.enumlist.PostCategory;
import com.exercise.carrotproject.domain.converter.LocConverter;
import com.exercise.carrotproject.domain.member.entity.Member;
import com.sun.istack.NotNull;
>>>>>>>> Stashed changes:src/main/java/com/exercise/carrotproject/domain/post/Post.java
import lombok.*;
